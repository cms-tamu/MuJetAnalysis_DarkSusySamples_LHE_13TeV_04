...
//=========  (Wed Mar 18 14:12:01 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-53.125,-0.00372944,259.375,0.02495856);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.0229504);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.01272945);
   h_gammaD_1_cT->SetBinContent(2,0.00470492);
   h_gammaD_1_cT->SetBinContent(3,0.001703119);
   h_gammaD_1_cT->SetBinContent(4,0.0006391418);
   h_gammaD_1_cT->SetBinContent(5,0.0002233722);
   h_gammaD_1_cT->SetBinContent(6,0.0001460608);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.01275022);
   h_gammaD_2_cT->SetBinContent(2,0.004697768);
   h_gammaD_2_cT->SetBinContent(3,0.001691438);
   h_gammaD_2_cT->SetBinContent(4,0.0006305138);
   h_gammaD_2_cT->SetBinContent(5,0.0002300558);
