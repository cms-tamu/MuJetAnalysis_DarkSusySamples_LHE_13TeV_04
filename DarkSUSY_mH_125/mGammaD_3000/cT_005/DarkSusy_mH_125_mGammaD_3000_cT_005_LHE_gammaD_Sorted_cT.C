...
//=========  (Mon Mar 16 12:47:30 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.053125,-3.73657,0.259375,25.00628);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(22.99428);
   ...
   h_gammaD_1_cT->SetBinContent(1,12.70491);
   h_gammaD_1_cT->SetBinContent(2,4.699321);
   h_gammaD_1_cT->SetBinContent(3,1.724134);
   h_gammaD_1_cT->SetBinContent(4,0.6339615);
   h_gammaD_1_cT->SetBinContent(5,0.2376726);
   h_gammaD_1_cT->SetBinContent(6,0.1414958);
   ...
   h_gammaD_2_cT->SetBinContent(1,12.7746);
   h_gammaD_2_cT->SetBinContent(2,4.652468);
   h_gammaD_2_cT->SetBinContent(3,1.703129);
   h_gammaD_2_cT->SetBinContent(4,0.6312823);
   h_gammaD_2_cT->SetBinContent(5,0.2385236);
