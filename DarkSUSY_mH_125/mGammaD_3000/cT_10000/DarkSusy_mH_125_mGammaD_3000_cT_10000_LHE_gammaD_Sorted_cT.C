...
//=========  (Wed Mar 18 14:09:55 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-106.25,-0.001869595,518.75,0.01251191);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.0115052);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.006391763);
   h_gammaD_1_cT->SetBinContent(2,0.002307983);
   h_gammaD_1_cT->SetBinContent(3,0.0008624726);
   h_gammaD_1_cT->SetBinContent(4,0.0003227349);
   h_gammaD_1_cT->SetBinContent(5,0.0001150467);
   h_gammaD_1_cT->SetBinContent(6,6.960703e-05);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.006391779);
   h_gammaD_2_cT->SetBinContent(2,0.002349967);
   h_gammaD_2_cT->SetBinContent(3,0.000833847);
   h_gammaD_2_cT->SetBinContent(4,0.0003083058);
   h_gammaD_2_cT->SetBinContent(5,0.0001161021);
   h_gammaD_2_cT->SetBinContent(6,6.289387e-05);
