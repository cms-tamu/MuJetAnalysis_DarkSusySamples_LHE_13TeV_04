...
//=========  (Wed Mar 18 14:10:15 2015) by ROOT version5.34/18
   ...
   cnv->Range(-21.25,-0.00929159,103.75,0.06218218);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.05717902);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.03181835);
   h_gammaD_1_cT->SetBinContent(2,0.01173931);
   h_gammaD_1_cT->SetBinContent(3,0.004262376);
   h_gammaD_1_cT->SetBinContent(4,0.00162553);
   h_gammaD_1_cT->SetBinContent(5,0.0005544298);
   h_gammaD_1_cT->SetBinContent(6,0.0003448667);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.03176612);
   h_gammaD_2_cT->SetBinContent(2,0.01172295);
   h_gammaD_2_cT->SetBinContent(3,0.004294471);
   h_gammaD_2_cT->SetBinContent(4,0.001623013);
   h_gammaD_2_cT->SetBinContent(5,0.0005934475);
   h_gammaD_2_cT->SetBinContent(6,0.0003448667);
