...
//=========  (Mon Mar 16 13:06:39 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-2.125,-0.09306784,10.375,0.6228387);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.5727252);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.3177653);
   h_gammaD_1_cT->SetBinContent(2,0.117399);
   h_gammaD_1_cT->SetBinContent(3,0.04356363);
   h_gammaD_1_cT->SetBinContent(4,0.01573376);
   h_gammaD_1_cT->SetBinContent(5,0.005538283);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.3181807);
   h_gammaD_2_cT->SetBinContent(2,0.1174357);
   h_gammaD_2_cT->SetBinContent(3,0.04298532);
   h_gammaD_2_cT->SetBinContent(4,0.01547773);
   h_gammaD_2_cT->SetBinContent(5,0.005920548);
   h_gammaD_2_cT->SetBinContent(6,0.003334634);
