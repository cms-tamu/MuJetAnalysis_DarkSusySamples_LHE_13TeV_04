...
//=========  (Mon Mar 16 12:59:00 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.53125,-0.371679,2.59375,2.48739);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(2.287255);
   ...
   h_gammaD_1_cT->SetBinContent(1,1.281614);
   h_gammaD_1_cT->SetBinContent(2,0.4614998);
   h_gammaD_1_cT->SetBinContent(3,0.1715091);
   h_gammaD_1_cT->SetBinContent(4,0.0650517);
   h_gammaD_1_cT->SetBinContent(5,0.02032551);
   h_gammaD_1_cT->SetBinContent(6,0.01240158);
   ...
   h_gammaD_2_cT->SetBinContent(1,1.270697);
   h_gammaD_2_cT->SetBinContent(2,0.4677927);
   h_gammaD_2_cT->SetBinContent(3,0.1726534);
   h_gammaD_2_cT->SetBinContent(4,0.06514461);
   h_gammaD_2_cT->SetBinContent(5,0.02371183);
