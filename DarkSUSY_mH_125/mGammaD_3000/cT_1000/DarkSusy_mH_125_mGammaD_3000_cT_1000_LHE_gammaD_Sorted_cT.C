...
//=========  (Wed Mar 18 14:10:03 2015) by ROOT version5.34/18
   ...
   cnv->Range(-10.625,-0.01861919,51.875,0.1246053);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.1145796);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.06349225);
   h_gammaD_1_cT->SetBinContent(2,0.02367911);
   h_gammaD_1_cT->SetBinContent(3,0.008566284);
   h_gammaD_1_cT->SetBinContent(4,0.003158054);
   h_gammaD_1_cT->SetBinContent(5,0.001104311);
   h_gammaD_1_cT->SetBinContent(6,0.000734109);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.06365535);
   h_gammaD_2_cT->SetBinContent(2,0.02353156);
   h_gammaD_2_cT->SetBinContent(3,0.008494257);
   h_gammaD_2_cT->SetBinContent(4,0.00317654);
   h_gammaD_2_cT->SetBinContent(5,0.001142296);
   h_gammaD_2_cT->SetBinContent(6,0.0006415982);
