...
//=========  (Mon Mar 16 13:11:17 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-3.1875,-0.06197037,15.5625,0.4147248);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.3813561);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.2112125);
   h_gammaD_1_cT->SetBinContent(2,0.07891568);
   h_gammaD_1_cT->SetBinContent(3,0.02865655);
   h_gammaD_1_cT->SetBinContent(4,0.01072575);
   h_gammaD_1_cT->SetBinContent(5,0.003822832);
   h_gammaD_1_cT->SetBinContent(6,0.002366715);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.2118645);
   h_gammaD_2_cT->SetBinContent(2,0.07914711);
   h_gammaD_2_cT->SetBinContent(3,0.02840048);
   h_gammaD_2_cT->SetBinContent(4,0.01026261);
   h_gammaD_2_cT->SetBinContent(5,0.003658624);
   h_gammaD_2_cT->SetBinContent(6,0.002316009);
