...
//=========  (Mon Mar 16 13:02:46 2015) by ROOT version5.34/18
   ...
   cnv->Range(-1.0625,-0.1862117,5.1875,1.246186);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(1.145918);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.6361829);
   h_gammaD_1_cT->SetBinContent(2,0.2331777);
   h_gammaD_1_cT->SetBinContent(3,0.08708455);
   h_gammaD_1_cT->SetBinContent(4,0.03206524);
   h_gammaD_1_cT->SetBinContent(5,0.01148962);
   h_gammaD_1_cT->SetBinContent(6,0.006745278);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.6366211);
   h_gammaD_2_cT->SetBinContent(2,0.235463);
   h_gammaD_2_cT->SetBinContent(3,0.0859319);
   h_gammaD_2_cT->SetBinContent(4,0.03120791);
   h_gammaD_2_cT->SetBinContent(5,0.01077611);
   h_gammaD_2_cT->SetBinContent(6,0.007100145);
