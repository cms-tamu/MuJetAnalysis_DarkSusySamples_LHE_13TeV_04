...
//=========  (Mon Mar 16 12:51:07 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.10625,-1.862846,0.51875,12.46674);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(11.46367);
   ...
   h_gammaD_1_cT->SetBinContent(1,6.386547);
   h_gammaD_1_cT->SetBinContent(2,2.334105);
   h_gammaD_1_cT->SetBinContent(3,0.8523113);
   h_gammaD_1_cT->SetBinContent(4,0.3087647);
   h_gammaD_1_cT->SetBinContent(5,0.1182717);
   ...
   h_gammaD_2_cT->SetBinContent(1,6.368704);
   h_gammaD_2_cT->SetBinContent(2,2.313868);
   h_gammaD_2_cT->SetBinContent(3,0.8742592);
   h_gammaD_2_cT->SetBinContent(4,0.3212412);
   h_gammaD_2_cT->SetBinContent(5,0.1219282);
