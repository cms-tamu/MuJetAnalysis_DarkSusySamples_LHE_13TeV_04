...
//=========  (Mon Mar 16 13:15:15 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-5.3125,-0.03719782,25.9375,0.2489393);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.2289097);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.1275813);
   h_gammaD_1_cT->SetBinContent(2,0.04662504);
   h_gammaD_1_cT->SetBinContent(3,0.01731917);
   h_gammaD_1_cT->SetBinContent(4,0.00620358);
   h_gammaD_1_cT->SetBinContent(5,0.002270953);
   h_gammaD_1_cT->SetBinContent(6,0.001412422);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1271721);
   h_gammaD_2_cT->SetBinContent(2,0.04692439);
   h_gammaD_2_cT->SetBinContent(3,0.01748465);
   h_gammaD_2_cT->SetBinContent(4,0.006219169);
   h_gammaD_2_cT->SetBinContent(5,0.002199738);
   h_gammaD_2_cT->SetBinContent(6,0.001346522);
