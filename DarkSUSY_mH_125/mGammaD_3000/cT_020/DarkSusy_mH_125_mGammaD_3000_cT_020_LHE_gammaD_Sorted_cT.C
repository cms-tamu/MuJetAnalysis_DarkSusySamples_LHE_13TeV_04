...
//=========  (Mon Mar 16 12:55:00 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.2125,-0.9327738,1.0375,6.242409);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(5.740147);
   ...
   h_gammaD_1_cT->SetBinContent(1,3.191203);
   h_gammaD_1_cT->SetBinContent(2,1.165874);
   h_gammaD_1_cT->SetBinContent(3,0.4233703);
   h_gammaD_1_cT->SetBinContent(4,0.1614548);
   h_gammaD_1_cT->SetBinContent(5,0.05809855);
   ...
   h_gammaD_2_cT->SetBinContent(1,3.18897);
   h_gammaD_2_cT->SetBinContent(2,1.159917);
   h_gammaD_2_cT->SetBinContent(3,0.4305711);
   h_gammaD_2_cT->SetBinContent(4,0.1597412);
   h_gammaD_2_cT->SetBinContent(5,0.06079984);
