...
//=========  (Tue Jun  9 17:12:42 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-2.125,-0.2924817,10.375,1.957378);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(1.799887);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.99995);
   h_gammaD_1_cT->SetBinContent(2,5.000062e-05);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.9999375);
   h_gammaD_2_cT->SetBinContent(2,6.250078e-05);
