...
//=========  (Tue Jun  9 17:19:54 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-2.125,-0.2526208,10.375,1.690616);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(1.554589);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.8650733);
   h_gammaD_1_cT->SetBinContent(2,0.1161764);
   h_gammaD_1_cT->SetBinContent(3,0.0159627);
   h_gammaD_1_cT->SetBinContent(4,0.002300029);
   h_gammaD_1_cT->SetBinContent(5,0.0004250053);
   h_gammaD_1_cT->SetBinContent(6,6.250078e-05);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.8636608);
   h_gammaD_2_cT->SetBinContent(2,0.1180515);
   h_gammaD_2_cT->SetBinContent(3,0.0156877);
   h_gammaD_2_cT->SetBinContent(4,0.002187527);
   h_gammaD_2_cT->SetBinContent(5,0.0003250041);
   h_gammaD_2_cT->SetBinContent(6,8.75011e-05);
