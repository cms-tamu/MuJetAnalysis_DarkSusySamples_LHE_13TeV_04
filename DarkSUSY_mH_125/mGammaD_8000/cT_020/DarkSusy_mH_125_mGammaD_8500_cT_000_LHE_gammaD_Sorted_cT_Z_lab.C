...
//=========  (Tue Jun  9 17:16:26 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-2.125,-0.164706,10.375,1.102263);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_Z_lab_dummy->SetMaximum(1.013576);
   ...
   h_gammaD_1_cT_Z_lab->SetBinContent(1,0.5471882);
   h_gammaD_1_cT_Z_lab->SetBinContent(2,0.1698315);
   h_gammaD_1_cT_Z_lab->SetBinContent(3,0.09195713);
   h_gammaD_1_cT_Z_lab->SetBinContent(4,0.05816924);
   h_gammaD_1_cT_Z_lab->SetBinContent(5,0.04028868);
   h_gammaD_1_cT_Z_lab->SetBinContent(6,0.02889541);
   h_gammaD_1_cT_Z_lab->SetBinContent(7,0.02074577);
   h_gammaD_1_cT_Z_lab->SetBinContent(8,0.01794813);
   h_gammaD_1_cT_Z_lab->SetBinContent(9,0.01382601);
   h_gammaD_1_cT_Z_lab->SetBinContent(10,0.01115);
   h_gammaD_1_cT_Z_lab->SetBinContent(11,0.08119906);
   ...
   h_gammaD_2_cT_Z_lab->SetBinContent(1,0.5630975);
   h_gammaD_2_cT_Z_lab->SetBinContent(2,0.1688717);
   h_gammaD_2_cT_Z_lab->SetBinContent(3,0.0874287);
   h_gammaD_2_cT_Z_lab->SetBinContent(4,0.05411232);
   h_gammaD_2_cT_Z_lab->SetBinContent(5,0.03920833);
   h_gammaD_2_cT_Z_lab->SetBinContent(6,0.02721016);
   h_gammaD_2_cT_Z_lab->SetBinContent(7,0.02020676);
   h_gammaD_2_cT_Z_lab->SetBinContent(8,0.01672514);
   h_gammaD_2_cT_Z_lab->SetBinContent(9,0.01293554);
   h_gammaD_2_cT_Z_lab->SetBinContent(10,0.01020381);
   h_gammaD_2_cT_Z_lab->SetBinContent(11,0.07125258);
