...
//=========  (Tue Jun  9 17:32:41 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-2.125,-0.08648089,10.375,0.5787568);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.5321901);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.2925099);
   h_gammaD_1_cT->SetBinContent(2,0.2103051);
   h_gammaD_1_cT->SetBinContent(3,0.1499066);
   h_gammaD_1_cT->SetBinContent(4,0.1083956);
   h_gammaD_1_cT->SetBinContent(5,0.0785466);
   h_gammaD_1_cT->SetBinContent(6,0.0559231);
   h_gammaD_1_cT->SetBinContent(7,0.04033053);
   h_gammaD_1_cT->SetBinContent(8,0.0275659);
   h_gammaD_1_cT->SetBinContent(9,0.02128736);
   h_gammaD_1_cT->SetBinContent(10,0.01522935);
   h_gammaD_1_cT->SetBinContent(11,0.03776204);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.2956612);
   h_gammaD_2_cT->SetBinContent(2,0.2095584);
   h_gammaD_2_cT->SetBinContent(3,0.1494366);
   h_gammaD_2_cT->SetBinContent(4,0.1077192);
   h_gammaD_2_cT->SetBinContent(5,0.07852609);
   h_gammaD_2_cT->SetBinContent(6,0.05698744);
   h_gammaD_2_cT->SetBinContent(7,0.03960627);
   h_gammaD_2_cT->SetBinContent(8,0.02826059);
   h_gammaD_2_cT->SetBinContent(9,0.01988084);
   h_gammaD_2_cT->SetBinContent(10,0.01436342);
   h_gammaD_2_cT->SetBinContent(11,0.03612226);
