...
//=========  (Thu Jun 11 16:29:33 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-21.25,-0.009329706,103.75,0.06243727);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.05741358);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.03185479);
   h_gammaD_1_cT->SetBinContent(2,0.01167862);
   h_gammaD_1_cT->SetBinContent(3,0.004317353);
   h_gammaD_1_cT->SetBinContent(4,0.001567258);
   h_gammaD_1_cT->SetBinContent(5,0.0005819806);
   h_gammaD_1_cT->SetBinContent(6,0.00033283);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.03189643);
   h_gammaD_2_cT->SetBinContent(2,0.01172214);
   h_gammaD_2_cT->SetBinContent(3,0.004300006);
   h_gammaD_2_cT->SetBinContent(4,0.001540301);
   h_gammaD_2_cT->SetBinContent(5,0.0005411187);
   h_gammaD_2_cT->SetBinContent(6,0.000335997);
