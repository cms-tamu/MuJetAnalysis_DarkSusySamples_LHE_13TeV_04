...
//=========  (Thu Jun 11 15:33:57 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-1.0625,-0.186633,5.1875,1.249006);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(1.148511);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.6356723);
   h_gammaD_1_cT->SetBinContent(2,0.2332196);
   h_gammaD_1_cT->SetBinContent(3,0.08680105);
   h_gammaD_1_cT->SetBinContent(4,0.03263538);
   h_gammaD_1_cT->SetBinContent(5,0.01167168);
   h_gammaD_1_cT->SetBinContent(6,0.007252307);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.6380617);
   h_gammaD_2_cT->SetBinContent(2,0.2332284);
   h_gammaD_2_cT->SetBinContent(3,0.08623033);
   h_gammaD_2_cT->SetBinContent(4,0.03122719);
   h_gammaD_2_cT->SetBinContent(5,0.01125236);
   h_gammaD_2_cT->SetBinContent(6,0.006910007);
