...
//=========  (Tue Jun  9 17:28:41 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-2.125,-0.1147689,10.375,0.768069);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.7062704);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.3957597);
   h_gammaD_1_cT->SetBinContent(2,0.242743);
   h_gammaD_1_cT->SetBinContent(3,0.1471406);
   h_gammaD_1_cT->SetBinContent(4,0.08649261);
   h_gammaD_1_cT->SetBinContent(5,0.05160113);
   h_gammaD_1_cT->SetBinContent(6,0.03276502);
   h_gammaD_1_cT->SetBinContent(7,0.01967914);
   h_gammaD_1_cT->SetBinContent(8,0.01187795);
   h_gammaD_1_cT->SetBinContent(9,0.007700535);
   h_gammaD_1_cT->SetBinContent(10,0.004240327);
   h_gammaD_1_cT->SetBinContent(11,0.006593268);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.3923724);
   h_gammaD_2_cT->SetBinContent(2,0.2412548);
   h_gammaD_2_cT->SetBinContent(3,0.1473944);
   h_gammaD_2_cT->SetBinContent(4,0.08882907);
   h_gammaD_2_cT->SetBinContent(5,0.05396159);
   h_gammaD_2_cT->SetBinContent(6,0.03256563);
   h_gammaD_2_cT->SetBinContent(7,0.02015069);
   h_gammaD_2_cT->SetBinContent(8,0.01152187);
   h_gammaD_2_cT->SetBinContent(9,0.007220035);
   h_gammaD_2_cT->SetBinContent(10,0.0047295);
   h_gammaD_2_cT->SetBinContent(11,0.006264072);
