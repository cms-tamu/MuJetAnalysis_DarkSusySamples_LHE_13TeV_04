...
//=========  (Thu Jun 11 15:38:09 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-2.125,-0.09266798,10.375,0.6201627);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.5702645);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.3192513);
   h_gammaD_1_cT->SetBinContent(2,0.1168166);
   h_gammaD_1_cT->SetBinContent(3,0.04218308);
   h_gammaD_1_cT->SetBinContent(4,0.01577855);
   h_gammaD_1_cT->SetBinContent(5,0.005970431);
   h_gammaD_1_cT->SetBinContent(6,0.003296634);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.3168136);
   h_gammaD_2_cT->SetBinContent(2,0.1181117);
   h_gammaD_2_cT->SetBinContent(3,0.04326361);
   h_gammaD_2_cT->SetBinContent(4,0.01583628);
   h_gammaD_2_cT->SetBinContent(5,0.005974768);
   h_gammaD_2_cT->SetBinContent(6,0.003132036);
