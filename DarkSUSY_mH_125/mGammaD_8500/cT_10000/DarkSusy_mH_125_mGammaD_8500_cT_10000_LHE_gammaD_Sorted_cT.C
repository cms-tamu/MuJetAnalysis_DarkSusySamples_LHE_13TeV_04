...
//=========  (Thu Jun 11 16:36:36 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-106.25,-0.001856647,518.75,0.01242525);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.01142552);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.006372364);
   h_gammaD_1_cT->SetBinContent(2,0.002337561);
   h_gammaD_1_cT->SetBinContent(3,0.000856485);
   h_gammaD_1_cT->SetBinContent(4,0.0003173285);
   h_gammaD_1_cT->SetBinContent(5,0.0001162615);
   h_gammaD_1_cT->SetBinContent(6,6.580603e-05);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.006347512);
   h_gammaD_2_cT->SetBinContent(2,0.002342049);
   h_gammaD_2_cT->SetBinContent(3,0.0008628004);
   h_gammaD_2_cT->SetBinContent(4,0.0003266657);
   h_gammaD_2_cT->SetBinContent(5,0.0001209733);
