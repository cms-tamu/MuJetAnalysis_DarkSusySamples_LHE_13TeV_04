...
//=========  (Thu Jun 11 15:22:52 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.2125,-0.9321121,1.0375,6.237981);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(5.736075);
   ...
   h_gammaD_1_cT->SetBinContent(1,3.179199);
   h_gammaD_1_cT->SetBinContent(2,1.163685);
   h_gammaD_1_cT->SetBinContent(3,0.4408878);
   h_gammaD_1_cT->SetBinContent(4,0.1557703);
   h_gammaD_1_cT->SetBinContent(5,0.0604585);
   ...
   h_gammaD_2_cT->SetBinContent(1,3.186708);
   h_gammaD_2_cT->SetBinContent(2,1.159455);
   h_gammaD_2_cT->SetBinContent(3,0.4328296);
   h_gammaD_2_cT->SetBinContent(4,0.1636322);
   h_gammaD_2_cT->SetBinContent(5,0.05737509);
   h_gammaD_2_cT->SetBinContent(6,0.03283969);
