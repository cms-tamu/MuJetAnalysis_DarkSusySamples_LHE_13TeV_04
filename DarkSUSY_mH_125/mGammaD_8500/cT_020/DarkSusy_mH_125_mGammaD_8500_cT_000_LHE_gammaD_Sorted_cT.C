...
//=========  (Tue Jun  9 17:16:22 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-2.125,-0.2905914,10.375,1.944727);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(1.788255);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.9934624);
   h_gammaD_1_cT->SetBinContent(2,0.00642508);
   h_gammaD_1_cT->SetBinContent(3,0.0001125014);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.9934749);
   h_gammaD_2_cT->SetBinContent(2,0.006450081);
   h_gammaD_2_cT->SetBinContent(3,7.500093e-05);
