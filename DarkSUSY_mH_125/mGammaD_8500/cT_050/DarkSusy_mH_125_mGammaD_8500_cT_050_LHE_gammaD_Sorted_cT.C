...
//=========  (Thu Jun 11 15:28:32 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.53125,-0.3717727,2.59375,2.488017);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(2.287832);
   ...
   h_gammaD_1_cT->SetBinContent(1,1.270582);
   h_gammaD_1_cT->SetBinContent(2,0.472068);
   h_gammaD_1_cT->SetBinContent(3,0.1696443);
   h_gammaD_1_cT->SetBinContent(4,0.06438779);
   h_gammaD_1_cT->SetBinContent(5,0.0233176);
   h_gammaD_1_cT->SetBinContent(6,0.01445389);
   ...
   h_gammaD_2_cT->SetBinContent(1,1.271018);
   h_gammaD_2_cT->SetBinContent(2,0.4683492);
   h_gammaD_2_cT->SetBinContent(3,0.1731261);
   h_gammaD_2_cT->SetBinContent(4,0.06462333);
   h_gammaD_2_cT->SetBinContent(5,0.02288376);
   h_gammaD_2_cT->SetBinContent(6,0.01394676);
