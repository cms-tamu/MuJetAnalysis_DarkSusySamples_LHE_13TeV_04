...
//=========  (Thu Jun 11 16:26:04 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-10.625,-0.0186676,51.875,0.1249293);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.1148775);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.06380304);
   h_gammaD_1_cT->SetBinContent(2,0.02336035);
   h_gammaD_1_cT->SetBinContent(3,0.008428549);
   h_gammaD_1_cT->SetBinContent(4,0.003232748);
   h_gammaD_1_cT->SetBinContent(5,0.001175316);
   h_gammaD_1_cT->SetBinContent(6,0.0006681935);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.06382085);
   h_gammaD_2_cT->SetBinContent(2,0.02336542);
   h_gammaD_2_cT->SetBinContent(3,0.008575203);
   h_gammaD_2_cT->SetBinContent(4,0.003107504);
   h_gammaD_2_cT->SetBinContent(5,0.001131031);
   h_gammaD_2_cT->SetBinContent(6,0.0006466629);
