...
//=========  (Thu Jun 11 16:18:59 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-3.1875,-0.06200129,15.5625,0.4149318);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.3815464);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.2111029);
   h_gammaD_1_cT->SetBinContent(2,0.07854737);
   h_gammaD_1_cT->SetBinContent(3,0.02884377);
   h_gammaD_1_cT->SetBinContent(4,0.01086624);
   h_gammaD_1_cT->SetBinContent(5,0.003973099);
   h_gammaD_1_cT->SetBinContent(6,0.002299111);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.2119702);
   h_gammaD_2_cT->SetBinContent(2,0.078756);
   h_gammaD_2_cT->SetBinContent(3,0.02841171);
   h_gammaD_2_cT->SetBinContent(4,0.01029531);
   h_gammaD_2_cT->SetBinContent(5,0.003900058);
   h_gammaD_2_cT->SetBinContent(6,0.002151322);
