...
//=========  (Thu Jun 11 15:10:52 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.053125,-3.730866,0.259375,24.9681);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(22.95917);
   ...
   h_gammaD_1_cT->SetBinContent(1,12.72139);
   h_gammaD_1_cT->SetBinContent(2,4.704831);
   h_gammaD_1_cT->SetBinContent(3,1.720046);
   h_gammaD_1_cT->SetBinContent(4,0.6322439);
   h_gammaD_1_cT->SetBinContent(5,0.2214867);
   h_gammaD_1_cT->SetBinContent(6,0.1349055);
   ...
   h_gammaD_2_cT->SetBinContent(1,12.7551);
   h_gammaD_2_cT->SetBinContent(2,4.654921);
   h_gammaD_2_cT->SetBinContent(3,1.74226);
   h_gammaD_2_cT->SetBinContent(4,0.6171659);
   h_gammaD_2_cT->SetBinContent(5,0.2305562);
   h_gammaD_2_cT->SetBinContent(6,0.1356657);
