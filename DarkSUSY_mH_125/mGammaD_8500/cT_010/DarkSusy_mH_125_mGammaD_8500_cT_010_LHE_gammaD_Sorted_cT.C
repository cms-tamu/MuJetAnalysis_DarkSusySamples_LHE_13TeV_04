...
//=========  (Thu Jun 11 15:17:19 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.10625,-1.863341,0.51875,12.47005);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(11.46672);
   ...
   h_gammaD_1_cT->SetBinContent(1,6.364964);
   h_gammaD_1_cT->SetBinContent(2,2.328467);
   h_gammaD_1_cT->SetBinContent(3,0.8657186);
   h_gammaD_1_cT->SetBinContent(4,0.323559);
   h_gammaD_1_cT->SetBinContent(5,0.1172917);
   h_gammaD_1_cT->SetBinContent(6,0.06783287);
   ...
   h_gammaD_2_cT->SetBinContent(1,6.370398);
   h_gammaD_2_cT->SetBinContent(2,2.332444);
   h_gammaD_2_cT->SetBinContent(3,0.8652757);
   h_gammaD_2_cT->SetBinContent(4,0.3151033);
   h_gammaD_2_cT->SetBinContent(5,0.1167795);
