...
//=========  (Thu Jun 11 16:33:04 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-53.125,-0.003736508,259.375,0.02500586);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.0229939);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.01279553);
   h_gammaD_1_cT->SetBinContent(2,0.00462402);
   h_gammaD_1_cT->SetBinContent(3,0.001743792);
   h_gammaD_1_cT->SetBinContent(4,0.000605847);
   h_gammaD_1_cT->SetBinContent(5,0.0002308109);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.01277439);
   h_gammaD_2_cT->SetBinContent(2,0.004654381);
   h_gammaD_2_cT->SetBinContent(3,0.001694446);
   h_gammaD_2_cT->SetBinContent(4,0.0006453236);
   h_gammaD_2_cT->SetBinContent(5,0.0002314611);
   h_gammaD_2_cT->SetBinContent(6,0.0001268004);
