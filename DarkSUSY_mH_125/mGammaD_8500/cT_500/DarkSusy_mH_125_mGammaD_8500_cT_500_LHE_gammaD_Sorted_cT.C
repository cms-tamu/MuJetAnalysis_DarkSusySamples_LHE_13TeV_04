...
//=========  (Thu Jun 11 16:22:33 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-5.3125,-0.0372436,25.9375,0.2492456);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.2291914);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.1276673);
   h_gammaD_1_cT->SetBinContent(2,0.04680171);
   h_gammaD_1_cT->SetBinContent(3,0.01708858);
   h_gammaD_1_cT->SetBinContent(4,0.006152491);
   h_gammaD_1_cT->SetBinContent(5,0.002289884);
   h_gammaD_1_cT->SetBinContent(6,0.001305989);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1273285);
   h_gammaD_2_cT->SetBinContent(2,0.04706682);
   h_gammaD_2_cT->SetBinContent(3,0.01696741);
   h_gammaD_2_cT->SetBinContent(4,0.006392349);
   h_gammaD_2_cT->SetBinContent(5,0.002244872);
