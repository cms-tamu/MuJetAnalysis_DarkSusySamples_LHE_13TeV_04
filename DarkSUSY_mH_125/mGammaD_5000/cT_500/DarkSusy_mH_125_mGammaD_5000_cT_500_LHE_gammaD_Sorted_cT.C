...
//=========  (Mon Mar 16 13:52:52 2015) by ROOT version5.34/18
   ...
   cnv->Range(-5.3125,-0.03731139,25.9375,0.2496993);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.2296085);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.1273951);
   h_gammaD_1_cT->SetBinContent(2,0.04672328);
   h_gammaD_1_cT->SetBinContent(3,0.01722086);
   h_gammaD_1_cT->SetBinContent(4,0.006464113);
   h_gammaD_1_cT->SetBinContent(5,0.002196641);
   h_gammaD_1_cT->SetBinContent(6,0.001293326);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1275603);
   h_gammaD_2_cT->SetBinContent(2,0.04706252);
   h_gammaD_2_cT->SetBinContent(3,0.0170926);
   h_gammaD_2_cT->SetBinContent(4,0.005936607);
   h_gammaD_2_cT->SetBinContent(5,0.002347967);
   h_gammaD_2_cT->SetBinContent(6,0.00132372);
