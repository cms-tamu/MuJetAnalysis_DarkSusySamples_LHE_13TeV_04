...
//=========  (Mon Mar 16 13:23:34 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.053125,-3.718566,0.259375,24.88579);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(22.88348);
   ...
   h_gammaD_1_cT->SetBinContent(1,12.76731);
   h_gammaD_1_cT->SetBinContent(2,4.641904);
   h_gammaD_1_cT->SetBinContent(3,1.721733);
   h_gammaD_1_cT->SetBinContent(4,0.6464367);
   h_gammaD_1_cT->SetBinContent(5,0.2226139);
   h_gammaD_1_cT->SetBinContent(6,0.1458071);
   ...
   h_gammaD_2_cT->SetBinContent(1,12.71305);
   h_gammaD_2_cT->SetBinContent(2,4.683105);
   h_gammaD_2_cT->SetBinContent(3,1.724494);
   h_gammaD_2_cT->SetBinContent(4,0.6501447);
   h_gammaD_2_cT->SetBinContent(5,0.2292112);
   h_gammaD_2_cT->SetBinContent(6,0.1280664);
