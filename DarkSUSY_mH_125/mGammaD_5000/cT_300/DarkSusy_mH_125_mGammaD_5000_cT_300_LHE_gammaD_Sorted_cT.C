...
//=========  (Mon Mar 16 13:48:51 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-3.1875,-0.06209765,15.5625,0.4155766);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.3821394);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.211688);
   h_gammaD_1_cT->SetBinContent(2,0.07848468);
   h_gammaD_1_cT->SetBinContent(3,0.02886749);
   h_gammaD_1_cT->SetBinContent(4,0.01033709);
   h_gammaD_1_cT->SetBinContent(5,0.003956118);
   h_gammaD_1_cT->SetBinContent(6,0.002282214);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.2122997);
   h_gammaD_2_cT->SetBinContent(2,0.07782713);
   h_gammaD_2_cT->SetBinContent(3,0.0287694);
   h_gammaD_2_cT->SetBinContent(4,0.01058248);
   h_gammaD_2_cT->SetBinContent(5,0.003854656);
   h_gammaD_2_cT->SetBinContent(6,0.002214644);
