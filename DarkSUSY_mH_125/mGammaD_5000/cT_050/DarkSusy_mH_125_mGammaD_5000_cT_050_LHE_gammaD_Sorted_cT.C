...
//=========  (Mon Mar 16 13:35:36 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.53125,-0.3706438,2.59375,2.480462);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(2.280885);
   ...
   h_gammaD_1_cT->SetBinContent(1,1.269068);
   h_gammaD_1_cT->SetBinContent(2,0.4683834);
   h_gammaD_1_cT->SetBinContent(3,0.1761063);
   h_gammaD_1_cT->SetBinContent(4,0.06351005);
   h_gammaD_1_cT->SetBinContent(5,0.02293208);
   h_gammaD_1_cT->SetBinContent(6,0.01376932);
   ...
   h_gammaD_2_cT->SetBinContent(1,1.267158);
   h_gammaD_2_cT->SetBinContent(2,0.4718999);
   h_gammaD_2_cT->SetBinContent(3,0.1725014);
   h_gammaD_2_cT->SetBinContent(4,0.06528578);
   h_gammaD_2_cT->SetBinContent(5,0.02315456);
   h_gammaD_2_cT->SetBinContent(6,0.01341454);
