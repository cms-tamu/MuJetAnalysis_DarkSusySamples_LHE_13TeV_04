...
//=========  (Mon Mar 16 13:39:37 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-1.0625,-0.1859641,5.1875,1.244529);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(1.144395);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.6358444);
   h_gammaD_1_cT->SetBinContent(2,0.2338718);
   h_gammaD_1_cT->SetBinContent(3,0.08701942);
   h_gammaD_1_cT->SetBinContent(4,0.03135064);
   h_gammaD_1_cT->SetBinContent(5,0.01191375);
   h_gammaD_1_cT->SetBinContent(6,0.006428643);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.6357747);
   h_gammaD_2_cT->SetBinContent(2,0.2343308);
   h_gammaD_2_cT->SetBinContent(3,0.08704074);
   h_gammaD_2_cT->SetBinContent(4,0.03149567);
   h_gammaD_2_cT->SetBinContent(5,0.01135806);
   h_gammaD_2_cT->SetBinContent(6,0.006238758);
