...
//=========  (Mon Mar 16 13:31:40 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.2125,-0.9298202,1.0375,6.222643);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(5.721971);
   ...
   h_gammaD_1_cT->SetBinContent(1,3.168662);
   h_gammaD_1_cT->SetBinContent(2,1.172842);
   h_gammaD_1_cT->SetBinContent(3,0.4401934);
   h_gammaD_1_cT->SetBinContent(4,0.1590689);
   h_gammaD_1_cT->SetBinContent(5,0.0592338);
   h_gammaD_1_cT->SetBinContent(6,0.0357543);
   ...
   h_gammaD_2_cT->SetBinContent(1,3.178873);
   h_gammaD_2_cT->SetBinContent(2,1.178495);
   h_gammaD_2_cT->SetBinContent(3,0.4261986);
   h_gammaD_2_cT->SetBinContent(4,0.1576066);
   h_gammaD_2_cT->SetBinContent(5,0.05882723);
