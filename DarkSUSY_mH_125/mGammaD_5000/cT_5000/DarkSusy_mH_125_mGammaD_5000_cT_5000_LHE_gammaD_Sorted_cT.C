...
//=========  (Wed Mar 18 14:14:02 2015) by ROOT version5.34/18
   ...
   cnv->Range(-53.125,-0.003731133,259.375,0.02496989);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.02296082);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.0127674);
   h_gammaD_1_cT->SetBinContent(2,0.004680878);
   h_gammaD_1_cT->SetBinContent(3,0.001699049);
   h_gammaD_1_cT->SetBinContent(4,0.0006266673);
   h_gammaD_1_cT->SetBinContent(5,0.0002260029);
   h_gammaD_1_cT->SetBinContent(6,0.0001336387);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.01275601);
   h_gammaD_2_cT->SetBinContent(2,0.004636857);
   h_gammaD_2_cT->SetBinContent(3,0.001727935);
   h_gammaD_2_cT->SetBinContent(4,0.0006461194);
   h_gammaD_2_cT->SetBinContent(5,0.0002330762);
   h_gammaD_2_cT->SetBinContent(6,0.0001359192);
