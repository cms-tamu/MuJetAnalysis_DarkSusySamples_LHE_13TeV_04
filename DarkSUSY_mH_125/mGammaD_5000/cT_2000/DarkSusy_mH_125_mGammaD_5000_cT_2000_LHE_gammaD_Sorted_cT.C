...
//=========  (Wed Mar 18 14:13:45 2015) by ROOT version5.34/18
   ...
   cnv->Range(-21.25,-0.009309211,103.75,0.0623001);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.05728745);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.03182762);
   h_gammaD_1_cT->SetBinContent(2,0.0116849);
   h_gammaD_1_cT->SetBinContent(3,0.004334009);
   h_gammaD_1_cT->SetBinContent(4,0.001536128);
   h_gammaD_1_cT->SetBinContent(5,0.0006173461);
   h_gammaD_1_cT->SetBinContent(6,0.0003435994);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.03182636);
   h_gammaD_2_cT->SetBinContent(2,0.0117667);
   h_gammaD_2_cT->SetBinContent(3,0.004220105);
   h_gammaD_2_cT->SetBinContent(4,0.001571369);
   h_gammaD_2_cT->SetBinContent(5,0.0006154582);
   h_gammaD_2_cT->SetBinContent(6,0.0003435994);
