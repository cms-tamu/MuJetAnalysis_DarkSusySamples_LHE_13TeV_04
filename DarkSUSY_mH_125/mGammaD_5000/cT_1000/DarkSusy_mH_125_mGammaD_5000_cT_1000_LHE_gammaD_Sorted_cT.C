...
//=========  (Wed Mar 18 14:14:02 2015) by ROOT version5.34/18
   ...
   cnv->Range(-10.625,-0.01856686,51.875,0.1242551);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.1142576);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.06396553);
   h_gammaD_1_cT->SetBinContent(2,0.02314399);
   h_gammaD_1_cT->SetBinContent(3,0.008553815);
   h_gammaD_1_cT->SetBinContent(4,0.00319683);
   h_gammaD_1_cT->SetBinContent(5,0.001139838);
   h_gammaD_1_cT->SetBinContent(6,0.0006466629);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.06347644);
   h_gammaD_2_cT->SetBinContent(2,0.02346235);
   h_gammaD_2_cT->SetBinContent(3,0.008702436);
   h_gammaD_2_cT->SetBinContent(4,0.003202386);
   h_gammaD_2_cT->SetBinContent(5,0.001156382);
   h_gammaD_2_cT->SetBinContent(6,0.0006631266);
