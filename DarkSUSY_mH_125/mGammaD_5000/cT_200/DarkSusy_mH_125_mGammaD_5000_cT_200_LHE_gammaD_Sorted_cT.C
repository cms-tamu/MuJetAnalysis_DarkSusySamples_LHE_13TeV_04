...
//=========  (Mon Mar 16 13:44:21 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-2.125,-0.09347073,10.375,0.6255349);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.5752045);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.3172441);
   h_gammaD_1_cT->SetBinContent(2,0.1177992);
   h_gammaD_1_cT->SetBinContent(3,0.04328345);
   h_gammaD_1_cT->SetBinContent(4,0.01573257);
   h_gammaD_1_cT->SetBinContent(5,0.005940619);
   h_gammaD_1_cT->SetBinContent(6,0.003435994);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.3195581);
   h_gammaD_2_cT->SetBinContent(2,0.1159427);
   h_gammaD_2_cT->SetBinContent(3,0.04295548);
   h_gammaD_2_cT->SetBinContent(4,0.01553495);
   h_gammaD_2_cT->SetBinContent(5,0.006008859);
   h_gammaD_2_cT->SetBinContent(6,0.003353636);
