...
//=========  (Wed Mar 18 14:11:28 2015) by ROOT version5.34/18
   ...
   cnv->Range(-106.25,-0.001853854,518.75,0.01240657);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.01140834);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.00640545);
   h_gammaD_1_cT->SetBinContent(2,0.002327047);
   h_gammaD_1_cT->SetBinContent(3,0.0008437858);
   h_gammaD_1_cT->SetBinContent(4,0.000302691);
   h_gammaD_1_cT->SetBinContent(5,0.0001210261);
   h_gammaD_1_cT->SetBinContent(6,6.441305e-05);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.006337964);
   h_gammaD_2_cT->SetBinContent(2,0.002356665);
   h_gammaD_2_cT->SetBinContent(3,0.0008732256);
   h_gammaD_2_cT->SetBinContent(4,0.000312091);
   h_gammaD_2_cT->SetBinContent(5,0.0001200544);
   h_gammaD_2_cT->SetBinContent(6,6.732609e-05);
