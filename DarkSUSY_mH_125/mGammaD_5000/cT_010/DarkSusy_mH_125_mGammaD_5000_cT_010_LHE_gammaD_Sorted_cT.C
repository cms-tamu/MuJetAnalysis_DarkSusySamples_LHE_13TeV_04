...
//=========  (Mon Mar 16 13:27:41 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.10625,-1.866858,0.51875,12.49359);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(11.48835);
   ...
   h_gammaD_1_cT->SetBinContent(1,6.382261);
   h_gammaD_1_cT->SetBinContent(2,2.303685);
   h_gammaD_1_cT->SetBinContent(3,0.8796436);
   h_gammaD_1_cT->SetBinContent(4,0.3196416);
   h_gammaD_1_cT->SetBinContent(5,0.114769);
   h_gammaD_1_cT->SetBinContent(6,0.06732608);
   ...
   h_gammaD_2_cT->SetBinContent(1,6.382419);
   h_gammaD_2_cT->SetBinContent(2,2.31802);
   h_gammaD_2_cT->SetBinContent(3,0.8526166);
   h_gammaD_2_cT->SetBinContent(4,0.3296717);
   h_gammaD_2_cT->SetBinContent(5,0.1172725);
   h_gammaD_2_cT->SetBinContent(6,0.066186);
