...
//=========  (Mon Mar 16 14:29:56 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-5.3125,-0.03720559,25.9375,0.2489913);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.2289575);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.1271716);
   h_gammaD_1_cT->SetBinContent(2,0.04662195);
   h_gammaD_1_cT->SetBinContent(3,0.01734513);
   h_gammaD_1_cT->SetBinContent(4,0.006493098);
   h_gammaD_1_cT->SetBinContent(5,0.002368219);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1271986);
   h_gammaD_2_cT->SetBinContent(2,0.04696304);
   h_gammaD_2_cT->SetBinContent(3,0.01734469);
   h_gammaD_2_cT->SetBinContent(4,0.00624127);
   h_gammaD_2_cT->SetBinContent(5,0.002252394);
   h_gammaD_2_cT->SetBinContent(6,0.001328787);
