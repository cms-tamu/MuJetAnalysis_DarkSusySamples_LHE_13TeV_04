...
//=========  (Mon Mar 16 14:13:12 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.53125,-0.3724836,2.59375,2.492775);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(2.292207);
   ...
   h_gammaD_1_cT->SetBinContent(1,1.276554);
   h_gammaD_1_cT->SetBinContent(2,0.4690103);
   h_gammaD_1_cT->SetBinContent(3,0.1697828);
   h_gammaD_1_cT->SetBinContent(4,0.06187876);
   h_gammaD_1_cT->SetBinContent(5,0.0227736);
   h_gammaD_1_cT->SetBinContent(6,0.01311055);
   ...
   h_gammaD_2_cT->SetBinContent(1,1.273448);
   h_gammaD_2_cT->SetBinContent(2,0.4659417);
   h_gammaD_2_cT->SetBinContent(3,0.1727836);
   h_gammaD_2_cT->SetBinContent(4,0.06323314);
   h_gammaD_2_cT->SetBinContent(5,0.02459347);
   h_gammaD_2_cT->SetBinContent(6,0.01376932);
