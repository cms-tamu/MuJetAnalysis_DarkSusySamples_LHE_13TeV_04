...
//=========  (Mon Mar 16 14:08:31 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.2125,-0.9305897,1.0375,6.227793);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(5.726706);
   ...
   h_gammaD_1_cT->SetBinContent(1,3.191219);
   h_gammaD_1_cT->SetBinContent(2,1.164357);
   h_gammaD_1_cT->SetBinContent(3,0.4255882);
   h_gammaD_1_cT->SetBinContent(4,0.1601777);
   h_gammaD_1_cT->SetBinContent(5,0.05865841);
   h_gammaD_1_cT->SetBinContent(6,0.03499364);
   ...
   h_gammaD_2_cT->SetBinContent(1,3.181504);
   h_gammaD_2_cT->SetBinContent(2,1.160847);
   h_gammaD_2_cT->SetBinContent(3,0.4450417);
   h_gammaD_2_cT->SetBinContent(4,0.1543894);
   h_gammaD_2_cT->SetBinContent(5,0.05821858);
   h_gammaD_2_cT->SetBinContent(6,0.03505702);
