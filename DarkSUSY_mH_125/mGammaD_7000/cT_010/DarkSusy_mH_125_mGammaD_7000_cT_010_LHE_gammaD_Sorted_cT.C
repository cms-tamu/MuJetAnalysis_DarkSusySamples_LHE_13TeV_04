...
//=========  (Mon Mar 16 14:04:44 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.10625,-1.860832,0.51875,12.45326);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(11.45127);
   ...
   h_gammaD_1_cT->SetBinContent(1,6.339021);
   h_gammaD_1_cT->SetBinContent(2,2.35266);
   h_gammaD_1_cT->SetBinContent(3,0.8766168);
   h_gammaD_1_cT->SetBinContent(4,0.3110373);
   h_gammaD_1_cT->SetBinContent(5,0.1206654);
   h_gammaD_1_cT->SetBinContent(6,0.06580603);
   ...
   h_gammaD_2_cT->SetBinContent(1,6.361817);
   h_gammaD_2_cT->SetBinContent(2,2.315939);
   h_gammaD_2_cT->SetBinContent(3,0.8793145);
   h_gammaD_2_cT->SetBinContent(4,0.3193618);
   h_gammaD_2_cT->SetBinContent(5,0.1235671);
   h_gammaD_2_cT->SetBinContent(6,0.06643933);
