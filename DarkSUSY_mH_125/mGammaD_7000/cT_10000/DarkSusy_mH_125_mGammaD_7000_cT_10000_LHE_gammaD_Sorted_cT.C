...
//=========  (Wed Mar 18 14:14:08 2015) by ROOT version5.34/18
   ...
   cnv->Range(-106.25,-0.00186843,518.75,0.01250411);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.01149803);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.00636748);
   h_gammaD_1_cT->SetBinContent(2,0.002331488);
   h_gammaD_1_cT->SetBinContent(3,0.0008639567);
   h_gammaD_1_cT->SetBinContent(4,0.0003223005);
   h_gammaD_1_cT->SetBinContent(5,0.0001147747);
   h_gammaD_1_cT->SetBinContent(6,6.783287e-05);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.006387794);
   h_gammaD_2_cT->SetBinContent(2,0.002318131);
   h_gammaD_2_cT->SetBinContent(3,0.0008447992);
   h_gammaD_2_cT->SetBinContent(4,0.0003275469);
   h_gammaD_2_cT->SetBinContent(5,0.0001217286);
   h_gammaD_2_cT->SetBinContent(6,7.049434e-05);
