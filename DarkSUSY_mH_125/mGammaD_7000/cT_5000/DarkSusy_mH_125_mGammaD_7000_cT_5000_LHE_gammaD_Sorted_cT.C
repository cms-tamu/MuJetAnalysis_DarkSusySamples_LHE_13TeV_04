...
//=========  (Wed Mar 18 14:11:55 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-53.125,-0.00373323,259.375,0.02498392);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.02297372);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.01277655);
   h_gammaD_1_cT->SetBinContent(2,0.004646795);
   h_gammaD_1_cT->SetBinContent(3,0.001700317);
   h_gammaD_1_cT->SetBinContent(4,0.0006364231);
   h_gammaD_1_cT->SetBinContent(5,0.0002399174);
   h_gammaD_1_cT->SetBinContent(6,0.0001397211);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.01276318);
   h_gammaD_2_cT->SetBinContent(2,0.004629995);
   h_gammaD_2_cT->SetBinContent(3,0.001714487);
   h_gammaD_2_cT->SetBinContent(4,0.0006581215);
   h_gammaD_2_cT->SetBinContent(5,0.0002342168);
   h_gammaD_2_cT->SetBinContent(6,0.0001257877);
