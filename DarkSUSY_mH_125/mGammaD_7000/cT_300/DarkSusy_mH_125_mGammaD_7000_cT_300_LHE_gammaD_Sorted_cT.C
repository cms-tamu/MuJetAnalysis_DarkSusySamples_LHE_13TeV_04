...
//=========  (Mon Mar 16 14:25:45 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-3.1875,-0.06185174,15.5625,0.4139309);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.3806261);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.2122219);
   h_gammaD_1_cT->SetBinContent(2,0.07829122);
   h_gammaD_1_cT->SetBinContent(3,0.02885164);
   h_gammaD_1_cT->SetBinContent(4,0.01029397);
   h_gammaD_1_cT->SetBinContent(5,0.00367462);
   h_gammaD_1_cT->SetBinContent(6,0.002244203);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.2114589);
   h_gammaD_2_cT->SetBinContent(2,0.0779419);
   h_gammaD_2_cT->SetBinContent(3,0.02901851);
   h_gammaD_2_cT->SetBinContent(4,0.01107644);
   h_gammaD_2_cT->SetBinContent(5,0.00383754);
   h_gammaD_2_cT->SetBinContent(6,0.002185091);
