...
//=========  (Wed Mar 18 14:11:55 2015) by ROOT version5.34/18
   ...
   cnv->Range(-10.625,-0.01854664,51.875,0.1241198);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.1141332);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.06366097);
   h_gammaD_1_cT->SetBinContent(2,0.02338553);
   h_gammaD_1_cT->SetBinContent(3,0.008619301);
   h_gammaD_1_cT->SetBinContent(4,0.003193686);
   h_gammaD_1_cT->SetBinContent(5,0.001140512);
   h_gammaD_1_cT->SetBinContent(6,0.0007062111);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.06340733);
   h_gammaD_2_cT->SetBinContent(2,0.02368871);
   h_gammaD_2_cT->SetBinContent(3,0.008503222);
   h_gammaD_2_cT->SetBinContent(4,0.003177539);
   h_gammaD_2_cT->SetBinContent(5,0.001223195);
   h_gammaD_2_cT->SetBinContent(6,0.0006732608);
