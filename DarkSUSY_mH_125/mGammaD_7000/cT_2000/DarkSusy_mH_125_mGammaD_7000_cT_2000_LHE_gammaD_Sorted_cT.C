...
//=========  (Wed Mar 18 14:14:24 2015) by ROOT version5.34/18
   ...
   cnv->Range(-21.25,-0.009280677,103.75,0.06210915);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.05711186);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.03187312);
   h_gammaD_1_cT->SetBinContent(2,0.01161415);
   h_gammaD_1_cT->SetBinContent(3,0.004381272);
   h_gammaD_1_cT->SetBinContent(4,0.001559254);
   h_gammaD_1_cT->SetBinContent(5,0.0005722091);
   h_gammaD_1_cT->SetBinContent(6,0.000358811);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.03172881);
   h_gammaD_2_cT->SetBinContent(2,0.01176315);
   h_gammaD_2_cT->SetBinContent(3,0.004329887);
   h_gammaD_2_cT->SetBinContent(4,0.001593202);
   h_gammaD_2_cT->SetBinContent(5,0.0005849498);
   h_gammaD_2_cT->SetBinContent(6,0.000317634);
