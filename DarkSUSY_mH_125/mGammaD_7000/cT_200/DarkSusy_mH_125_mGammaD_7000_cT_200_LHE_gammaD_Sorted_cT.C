...
//=========  (Mon Mar 16 14:21:24 2015) by ROOT version5.34/18
   ...
   cnv->Range(-2.125,-0.0931162,10.375,0.6231623);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.5730228);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.3181051);
   h_gammaD_1_cT->SetBinContent(2,0.11757);
   h_gammaD_1_cT->SetBinContent(3,0.04264401);
   h_gammaD_1_cT->SetBinContent(4,0.01566887);
   h_gammaD_1_cT->SetBinContent(5,0.006011961);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.318346);
   h_gammaD_2_cT->SetBinContent(2,0.1167906);
   h_gammaD_2_cT->SetBinContent(3,0.04305561);
   h_gammaD_2_cT->SetBinContent(4,0.0160444);
   h_gammaD_2_cT->SetBinContent(5,0.005763398);
