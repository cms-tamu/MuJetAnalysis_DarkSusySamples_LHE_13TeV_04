...
//=========  (Mon Mar 16 14:00:49 2015) by ROOT version5.34/18
   ...
   cnv->Range(-0.053125,-3.718756,0.259375,24.88706);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(22.88466);
   ...
   h_gammaD_1_cT->SetBinContent(1,12.70713);
   h_gammaD_1_cT->SetBinContent(2,4.726769);
   h_gammaD_1_cT->SetBinContent(3,1.696046);
   h_gammaD_1_cT->SetBinContent(4,0.6406447);
   h_gammaD_1_cT->SetBinContent(5,0.2294132);
   ...
   h_gammaD_2_cT->SetBinContent(1,12.7137);
   h_gammaD_2_cT->SetBinContent(2,4.715007);
   h_gammaD_2_cT->SetBinContent(3,1.710588);
   h_gammaD_2_cT->SetBinContent(4,0.6406205);
   h_gammaD_2_cT->SetBinContent(5,0.2200874);
   h_gammaD_2_cT->SetBinContent(6,0.1450461);
