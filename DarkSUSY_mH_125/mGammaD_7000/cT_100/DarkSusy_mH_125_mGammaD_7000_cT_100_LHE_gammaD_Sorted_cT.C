...
//=========  (Mon Mar 16 14:16:53 2015) by ROOT version5.34/18
   ...
   cnv->Range(-1.0625,-0.1861912,5.1875,1.246049);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(1.145792);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.6367435);
   h_gammaD_1_cT->SetBinContent(2,0.2345937);
   h_gammaD_1_cT->SetBinContent(3,0.08472208);
   h_gammaD_1_cT->SetBinContent(4,0.03188249);
   h_gammaD_1_cT->SetBinContent(5,0.0120582);
   h_gammaD_1_cT->SetBinContent(6,0.006935354);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.6365513);
   h_gammaD_2_cT->SetBinContent(2,0.2348196);
   h_gammaD_2_cT->SetBinContent(3,0.08576535);
   h_gammaD_2_cT->SetBinContent(4,0.03083274);
   h_gammaD_2_cT->SetBinContent(5,0.01203106);
   h_gammaD_2_cT->SetBinContent(6,0.006770617);
